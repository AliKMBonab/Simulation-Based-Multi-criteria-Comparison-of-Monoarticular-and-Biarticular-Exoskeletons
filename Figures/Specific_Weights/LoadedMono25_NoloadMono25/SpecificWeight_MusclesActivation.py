...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono25_NoloadMono25/Monoarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono25_NoloadMono25/Monoarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
utils.plot_muscles_avg(plot_dic=muscles_activation_monoarticular_noload_plot_dic,toeoff_color='xkcd:shamrock green',color=mycolors['lavender purple'])
utils.plot_muscles_avg(plot_dic=muscles_activation_monoarticular_loaded_plot_dic,color=mycolors['dark purple'])
plt.legend(loc='best',frameon=False)
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono25_NoloadMono25/Monoarticular_LoadedVsNoload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
