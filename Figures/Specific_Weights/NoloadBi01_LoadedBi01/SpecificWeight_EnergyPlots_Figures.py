...
names = ['unassist, noload','bi, loaded','bi, noload']
data = [mean_noload_unassist_energy,mean_loaded_bi_energy,mean_noload_bi_energy]
err = [std_noload_unassist_energy,std_loaded_bi_energy,std_noload_bi_energy]
