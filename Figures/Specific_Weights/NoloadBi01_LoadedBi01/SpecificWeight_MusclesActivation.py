...
# monoarticular
bi_loaded_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['biarticular_hip70knee70_load_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
...
muscles_activation_biarticular_loaded_plot_dic = {'pgc':gait_cycle,'avg':mean_bi_loaded_muscles_activation,'muscle_group': 'nine_muscles',
                                                'label':'noload, monoarticular','std':std_bi_loaded_muscles_activation,'avg_toeoff':loaded_mean_toe_off}
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_LoadedBi01/Biarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_LoadedBi01/Biarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_LoadedBi01/Biarticular_NoloadVsLoaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
