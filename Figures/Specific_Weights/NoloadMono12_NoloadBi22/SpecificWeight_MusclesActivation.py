...
directory = './Data/Specific_Weights/*_activation.csv'
...
# monoarticular
mono_noload_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['monoarticular_hip50knee60_noload_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono12_NoloadBi22/Biarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono12_NoloadBi22/Monoarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')

# monoarticular versus biarticular
fig, ax = plt.subplots(num='Noload Muscles Activation',figsize=(9.4, 7.8))
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono12_NoloadBi22/MonoarticularVSBiarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
