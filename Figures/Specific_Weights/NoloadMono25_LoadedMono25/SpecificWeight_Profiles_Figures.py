...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/RMSE.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
mono_loaded_modified_AF_dic = {'positive_power' : exo_power_dataset['monoarticular_hip30knee30_load_hipactuator_avg_positive_power']+exo_power_dataset['monoarticular_hip30knee30_load_kneeactuator_avg_positive_power'],
...
ax.axis('off')
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exos_Inertial_Properties.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/PaperFigure_TorqueProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/PaperFigure_PowerProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
fig = plt.figure(num='Main Paper figure',figsize=(6.4*3.8,4.8*1.5))
utils.nested_plots(fig,plot_dic_1,plot_dic_2,monovsmono_color_dic,monovsmono_color_dic)
fig.tight_layout(h_pad=-1, w_pad=-1.5)
fig.subplots_adjust(top=0.98, bottom=0.075, left=0.100, right=0.975,hspace=0.30,wspace=0.30)
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/PaperFigure_Profiles.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
