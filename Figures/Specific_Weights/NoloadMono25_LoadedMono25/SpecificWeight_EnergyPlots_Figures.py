...
metabolic_rate_data = np.concatenate((np.reshape(unassisted_energy_dataset['noload_metabolics_energy'],(7,3)),\
                                ...
                                np.reshape(assisted_energy_dataset['monoarticular_hip30knee30_load_metabolics_energy'],(7,3)),\
...
assistive_actuators_avg_totalpower_data = np.concatenate((np.reshape(assisted_energy_dataset['monoarticular_hip30knee30_noload_hipactuator_energy'],(7,3)),\
                                                        ...
                                                        np.reshape(assisted_energy_dataset['monoarticular_hip30knee30_load_hipactuator_energy'],(7,3)),\
                                                        np.reshape(assisted_energy_dataset['monoarticular_hip30knee30_load_kneeactuator_energy'],(7,3))),axis=0)
