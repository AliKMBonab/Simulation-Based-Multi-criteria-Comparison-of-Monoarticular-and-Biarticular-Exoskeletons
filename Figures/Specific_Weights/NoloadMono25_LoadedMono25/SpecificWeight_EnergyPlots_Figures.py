...
metabolic_rate_data = np.concatenate((utils.mean_over_trials(unassisted_energy_dataset['noload_metabolics_energy']),\
                                ...
                                utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_load_metabolics_energy']),\
...
with open(r'.\Statistics\Specific_Weights\NoloadMono25_LoadedMono25\MetabolicRate_Dataset.csv', 'wb') as f:
...
assistive_actuators_avg_totalpower_data = np.concatenate((utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_hipactuator_energy']),\
                                                        ...
                                                        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_load_hipactuator_energy']),\
                                                        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_load_kneeactuator_energy'])),axis=0)
final_dataset = np.transpose(np.array([subject_col,assistive_actuators_col,assistive_actuators_avg_totalpower_data]))
with open(r'.\Statistics\Specific_Weights\NoloadMono25_LoadedMono25\ActuatorsAvgPower_Dataset.csv', 'wb') as f:
  f.write(bytes(utils.listToString(headers)+'\n','UTF-8'))
  np.savetxt(f, final_dataset, fmt='%s', delimiter=",")
...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Metabolic_Rate_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Metabolic_Percent_ParPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Metabolic_Rate_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_hipactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_kneeactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_load_hipactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_load_kneeactuator_energy'])]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
bp = ax.boxplot(data, patch_artist=True)
utils.beautiful_boxplot(bp)
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono25/PaperFigure_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
