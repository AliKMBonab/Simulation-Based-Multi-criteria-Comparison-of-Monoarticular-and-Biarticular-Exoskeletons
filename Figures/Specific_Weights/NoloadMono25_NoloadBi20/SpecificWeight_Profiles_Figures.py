...
# biarticular
# hip
bi_noload_hip_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip40knee30_noload_hipactuator_torque'],gl_noload,direction=False)
mean_bi_noload_hip_torque,std_bi_noload_hip_torque = utils.mean_std_over_subjects(bi_noload_hip_torque)
# knee
bi_noload_knee_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip40knee30_noload_kneeactuator_torque'],gl_noload,direction=True)
...
# biarticular
# hip
bi_noload_hip_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip40knee30_noload_hipactuator_power'],gl_noload,direction=False)
mean_bi_noload_hip_power,std_bi_noload_hip_power = utils.mean_std_over_subjects(bi_noload_hip_power)
# knee
bi_noload_knee_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip40knee30_noload_kneeactuator_power'],gl_noload,direction=False)
...
# biarticular
# hip
bi_noload_hip_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip40knee30_noload_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_bi_noload_hip_speed,std_bi_noload_hip_speed = utils.mean_std_over_subjects(bi_noload_hip_speed)
# knee
bi_noload_knee_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip40knee30_noload_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
...
# hip muscles moment
# biarticular
bi_noload_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip40knee30_noload_hipmuscles_moment'],gl_noload,direction=True)
...
# knee muscles moment
# biarticular
bi_noload_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip40knee30_noload_kneemuscles_moment'],gl_noload,direction=True)
...
'color_2_list' : [mycolors['lavender purple'],mycolors['lavender purple'],mycolors['lavender purple']],
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
