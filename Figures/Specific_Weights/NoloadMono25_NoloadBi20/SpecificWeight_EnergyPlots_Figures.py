...
# Energy
noload_bi_metabolics = utils.reduction_calc(unassisted_energy_dataset['noload_metabolics_energy'],assisted_energy_dataset['biarticular_hip40knee30_noload_metabolics_energy'])
...
mean_noload_bi_energy,std_noload_bi_energy = utils.mean_std_over_subjects(assisted_energy_dataset['biarticular_hip40knee30_noload_metabolics_energy'],ax=0)
...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Metabolic_Rate_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Metabolic_Percent_ParPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [unassisted_energy_dataset['noload_metabolics_energy'],\
        assisted_energy_dataset['monoarticular_hip30knee30_noload_metabolics_energy'],assisted_energy_dataset['biarticular_hip40knee30_noload_metabolics_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip40knee30_noload_metabolics_energy'])]]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Metabolic_Rate_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
x = np.arange(1,len(names)+1,1)
data = [assisted_energy_dataset['biarticular_hip40knee30_noload_hipactuator_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip40knee30_noload_hipactuator_energy'])],\
        assisted_energy_dataset['biarticular_hip40knee30_noload_kneeactuator_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip40knee30_noload_kneeactuator_energy'])],\
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_NoloadBi20/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
