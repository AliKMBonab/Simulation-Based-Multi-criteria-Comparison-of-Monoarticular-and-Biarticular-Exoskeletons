...
assistive_actuators_avg_totalpower_data = np.concatenate((np.reshape(assisted_energy_dataset['biarticular_hip40knee70_load_hipactuator_energy'],(7,3)),\
                                                np.reshape(assisted_energy_dataset['biarticular_hip40knee70_load_kneeactuator_energy'],(7,3)),\
