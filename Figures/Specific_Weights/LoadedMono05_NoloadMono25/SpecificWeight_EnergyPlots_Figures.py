...
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Metabolics_Energy_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
utils.no_top_right(ax)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Metabolics_Reduction_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
utils.no_top_right(ax)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Metabolics_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
utils.no_top_right(ax)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
