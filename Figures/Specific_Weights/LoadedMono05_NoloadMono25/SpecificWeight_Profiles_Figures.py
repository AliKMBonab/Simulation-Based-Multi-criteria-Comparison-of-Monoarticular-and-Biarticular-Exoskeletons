...
'plot_3_list' : [mono_loaded_hip_musclesmoment_dic,mono_noload_hip_musclesmoment_dic],
'plot_2_list' : [mono_loaded_hip_torque_dic,mono_noload_hip_torque_dic],
'plot_titles' : ['loaded monoarticular hip joint','noload monoarticular hip joint']
}
# plot
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_3_list' : [mono_loaded_knee_musclesmoment_dic,mono_noload_knee_musclesmoment_dic],
'plot_2_list' : [mono_loaded_knee_torque_dic,mono_noload_knee_torque_dic],
'plot_titles' : ['loaded monoarticular knee joint','noload monoarticular knee joint']
}
# plot
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_2_list' : [mono_loaded_knee_power_dic,mono_noload_knee_power_dic],
'plot_titles' : ['loaded monoarticular knee joint','noload monoarticular knee joint']
}
# 
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
'plot_2_list' : [mono_loaded_hip_speed_dic,mono_noload_hip_speed_dic],
'plot_titles' : ['loaded monoarticular hip joint','noload monoarticular hip joint']
}
# plot
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_2_list' : [mono_loaded_knee_speed_dic,mono_noload_knee_speed_dic],
'plot_titles' : ['loaded monoarticular knee joint','noload monoarticular knee joint']
}
# plot
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
