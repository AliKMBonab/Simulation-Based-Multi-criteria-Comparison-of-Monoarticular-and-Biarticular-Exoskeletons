...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Monoarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Monoarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono05_NoloadMono25/Monoarticular_LoadedVsNoload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
