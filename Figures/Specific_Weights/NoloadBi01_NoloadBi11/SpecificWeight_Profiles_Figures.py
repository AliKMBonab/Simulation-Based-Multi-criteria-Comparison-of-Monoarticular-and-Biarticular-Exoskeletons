...
# biarticular
# hip
bi_noload_hip_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip70knee70_noload_hipactuator_torque'],gl_noload,direction=False)
mean_bi_noload_hip_torque,std_bi_noload_hip_torque = utils.mean_std_over_subjects(bi_noload_hip_torque,avg_trials=False)
# knee
bi_noload_knee_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip70knee70_noload_kneeactuator_torque'],gl_noload,direction=True)
mean_bi_noload_knee_torque,std_bi_noload_knee_torque = utils.mean_std_over_subjects(bi_noload_knee_torque,avg_trials=False)
# biarticular
# hip
bi_loaded_hip_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip30knee70_noload_hipactuator_torque'],gl_noload,direction=False)
mean_bi_loaded_hip_torque,std_bi_loaded_hip_torque = utils.mean_std_over_subjects(bi_loaded_hip_torque,avg_trials=False)
# knee
bi_loaded_knee_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip30knee70_noload_kneeactuator_torque'],gl_noload,direction=True)
...
# biarticular
# hip
bi_noload_hip_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip70knee70_noload_hipactuator_power'],gl_noload,direction=False)
mean_bi_noload_hip_power,std_bi_noload_hip_power = utils.mean_std_over_subjects(bi_noload_hip_power,avg_trials=False)
# knee
bi_noload_knee_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip70knee70_noload_kneeactuator_power'],gl_noload,direction=False)
mean_bi_noload_knee_power,std_bi_noload_knee_power = utils.mean_std_over_subjects(bi_noload_knee_power,avg_trials=False)
# biarticular
# hip
bi_loaded_hip_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip30knee70_noload_hipactuator_power'],gl_noload,direction=False)
mean_bi_loaded_hip_power,std_bi_loaded_hip_power = utils.mean_std_over_subjects(bi_loaded_hip_power,avg_trials=False)
# knee
bi_loaded_knee_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip30knee70_load_kneeactuator_power'],gl_noload,direction=False)
...
# biarticular
# hip
bi_noload_hip_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip70knee70_noload_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_bi_noload_hip_speed,std_bi_noload_hip_speed = utils.mean_std_over_subjects(bi_noload_hip_speed,avg_trials=False)
# knee
bi_noload_knee_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip70knee70_noload_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
mean_bi_noload_knee_speed,std_bi_noload_knee_speed = utils.mean_std_over_subjects(bi_noload_knee_speed,avg_trials=False)
# monoarticular
# hip
bi_loaded_hip_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip30knee70_noload_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_bi_loaded_hip_speed,std_bi_loaded_hip_speed = utils.mean_std_over_subjects(bi_loaded_hip_speed,avg_trials=False)
# knee
bi_loaded_knee_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip30knee70_noload_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
mean_bi_loaded_knee_speed,std_bi_loaded_knee_speed = utils.mean_std_over_subjects(bi_loaded_knee_speed,avg_trials=False)
#******************************
# hip muscles moment
# biarticular
bi_noload_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip70knee70_noload_hipmuscles_moment'],gl_noload,direction=True)
...
# monoarticular
bi_loaded_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip30knee70_noload_hipmuscles_moment'],gl_noload,direction=True)
...
# knee muscles moment
# biarticular
bi_noload_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip70knee70_noload_kneemuscles_moment'],gl_noload,direction=True)
...
# monoarticular
bi_loaded_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip30knee70_load_kneemuscles_moment'],gl_noload,direction=True)
...
# rmse and tables
# torque difference
mean_rmse_hip_actuator_torque,std_rmse_hip_actuator_torque = utils.profiles_all_phases_rmse(bi_noload_hip_torque,bi_loaded_hip_torque,noload_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
mean_rmse_knee_actuator_torque,std_rmse_knee_actuator_torque = utils.profiles_all_phases_rmse(bi_noload_knee_torque,bi_loaded_knee_torque,noload_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
# power difference
mean_rmse_hip_actuator_power,std_rmse_hip_actuator_power = utils.profiles_all_phases_rmse(bi_noload_hip_power,bi_loaded_hip_power,noload_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
mean_rmse_knee_actuator_power,std_rmse_knee_actuator_power = utils.profiles_all_phases_rmse(bi_noload_knee_power,bi_loaded_knee_power,noload_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
# muscles moment difference
mean_rmse_hip_musclesmoment,std_rmse_hip_musclesmoment = utils.profiles_all_phases_rmse(bi_noload_hipmuscles_moment,bi_loaded_hipmuscles_moment,noload_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
mean_rmse_knee_musclesmoment,std_rmse_knee_musclesmoment = utils.profiles_all_phases_rmse(bi_noload_kneemuscles_moment,bi_loaded_kneemuscles_moment,noload_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
# RMSE plot       
...
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/RMSE.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
bi_loaded_m_waist = 2*4.5
bi_loaded_m_thigh = 2*1
...
ax.axis('off')
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exos_Inertial_Properties.pdf',orientation='landscape',bbox_inches='tight')
plt.show()

#####################################################################################
# Plots
# hip joint moment plot dictionaries
bi_noload_hip_musclesmoment_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_hipmuscles_moment,3),'label':'noload "Aa" muscles',
                        'std':utils.smooth(std_bi_noload_hipmuscles_moment,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_hip_musclesmoment_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_hipmuscles_moment,3),'label':'noload "Ea" muscles',
...
bi_noload_knee_musclesmoment_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_kneemuscles_moment,3),'label':'noload "Aa" muscles',
                        'std':utils.smooth(std_bi_noload_kneemuscles_moment,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_knee_musclesmoment_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_kneemuscles_moment,3),'label':'noload "Ea" muscles',
...
bi_noload_hip_torque_dic= {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_hip_torque,3),'label':'noload "Aa" actuator',
                        'std':utils.smooth(std_bi_noload_hip_torque,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_hip_torque_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_hip_torque,3),'label':'noload "Ea" actuator',
                        'std':utils.smooth(std_bi_loaded_hip_torque,3),'avg_toeoff':noload_mean_toe_off}

# knee actuator torque plot dictionaries
bi_noload_knee_torque_dic= {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_knee_torque,3),'label':'noload "Aa" actuator',
                        'std':utils.smooth(std_bi_noload_knee_torque,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_knee_torque_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_knee_torque,3),'label':'noload "Ea" actuator',
...
bi_noload_hip_power_dic= {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_hip_power,3),'label':'noload "Aa" actuator',
                        'std':utils.smooth(std_bi_noload_hip_power,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_hip_power_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_hip_power,3),'label':'noload "Ea" actuator',
                        'std':utils.smooth(std_bi_loaded_hip_power,3),'avg_toeoff':noload_mean_toe_off}

# knee actuator power plot dictionaries
bi_noload_knee_power_dic= {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_knee_power,3),'label':'noload "Aa" actuator',
                        'std':utils.smooth(std_bi_noload_knee_power,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_knee_power_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_knee_power,3),'label':'noload "Ea" actuator',
...
bi_noload_hip_speed_dic= {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_hip_speed,3),'label':'noload "Aa" actuator',
                        'std':utils.smooth(std_bi_noload_hip_speed,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_hip_speed_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_hip_speed,3),'label':'noload "Ea" actuator',
                        'std':utils.smooth(std_bi_loaded_hip_speed,3),'avg_toeoff':noload_mean_toe_off}

# knee actuator speed plot dictionaries
bi_noload_knee_speed_dic= {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_noload_knee_speed,3),'label':'noload "Aa" actuator',
                        'std':utils.smooth(std_bi_noload_knee_speed,3),'avg_toeoff':noload_mean_toe_off}
bi_loaded_knee_speed_dic = {'pgc':gait_cycle,'avg':utils.smooth(mean_bi_loaded_knee_speed,3),'label':'noload "Ea" actuator',
...
'color_2_list' : ['teal',mycolors['olympic blue'],'teal',mycolors['olympic blue']],
'color_3_list' : ['darkorange',mycolors['french rose'],'darkorange',mycolors['french rose']]
}
...
'plot_titles' : ['noload biarticular "Aa" hip joint','noload biarticular "Ea" hip joint','noload biarticular "Aa" knee joint','noload biarticular "Ea" knee joint']
}
# plot
fig = plt.figure(num='Paper Figure',figsize=(9.4, 6.8))
utils.plot_joint_muscle_exo(nrows=2,ncols=2,plot_dic=plot_dic,color_dic=monovsbi_color_dic,\
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/PaperFigure_PowerProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/PaperFigure_Profiles.pdf',orientation='landscape',bbox_inches='tight')
...
'plot_titles' : ['noload biarticular "Aa" hip joint','noload biarticular "Ea" hip joint']
}
# plot
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_titles' : ['noload biarticular "Aa" knee joint','noload biarticular "Ea" knee joint']
}
# plot
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi01_NoloadBi11/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
