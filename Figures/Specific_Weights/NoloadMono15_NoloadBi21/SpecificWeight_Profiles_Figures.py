...
# biarticular
# hip
bi_noload_hip_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip30knee70_noload_hipactuator_torque'],gl_noload,direction=False)
mean_bi_noload_hip_torque,std_bi_noload_hip_torque = utils.mean_std_over_subjects(bi_noload_hip_torque,avg_trials=False)
# knee
bi_noload_knee_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip30knee70_noload_kneeactuator_torque'],gl_noload,direction=True)
mean_bi_noload_knee_torque,std_bi_noload_knee_torque = utils.mean_std_over_subjects(bi_noload_knee_torque,avg_trials=False)
# monoarticular
# hip
mono_noload_hip_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip50knee30_noload_hipactuator_torque'],gl_noload,direction=False)
...
# knee
mono_noload_knee_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip50knee30_noload_kneeactuator_torque'],gl_noload,direction=True)
...
# biarticular
# hip
bi_noload_hip_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip30knee70_noload_hipactuator_power'],gl_noload,direction=False)
mean_bi_noload_hip_power,std_bi_noload_hip_power = utils.mean_std_over_subjects(bi_noload_hip_power,avg_trials=False)
# knee
bi_noload_knee_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip30knee70_noload_kneeactuator_power'],gl_noload,direction=False)
mean_bi_noload_knee_power,std_bi_noload_knee_power = utils.mean_std_over_subjects(bi_noload_knee_power,avg_trials=False)
# monoarticular
# hip
mono_noload_hip_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip50knee30_noload_hipactuator_power'],gl_noload,direction=False)
mean_mono_noload_hip_power,std_mono_noload_hip_power = utils.mean_std_over_subjects(mono_noload_hip_power,avg_trials=False)
# knee
mono_noload_knee_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip50knee30_noload_kneeactuator_power'],gl_noload,direction=False)
...
# biarticular
# hip
bi_noload_hip_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip30knee70_noload_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_bi_noload_hip_speed,std_bi_noload_hip_speed = utils.mean_std_over_subjects(bi_noload_hip_speed,avg_trials=False)
# knee
bi_noload_knee_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip30knee70_noload_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
mean_bi_noload_knee_speed,std_bi_noload_knee_speed = utils.mean_std_over_subjects(bi_noload_knee_speed,avg_trials=False)
# monoarticular
# hip
mono_noload_hip_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip50knee30_noload_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_mono_noload_hip_speed,std_mono_noload_hip_speed = utils.mean_std_over_subjects(mono_noload_hip_speed,avg_trials=False)
# knee
mono_noload_knee_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip50knee30_noload_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
...
# hip muscles moment
# biarticular
bi_noload_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip30knee70_noload_hipmuscles_moment'],gl_noload,direction=True)
...
# monoarticular
mono_noload_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip50knee30_noload_hipmuscles_moment'],gl_noload,direction=True)
...
# knee muscles moment
# biarticular
bi_noload_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip30knee70_noload_kneemuscles_moment'],gl_noload,direction=True)
...
# monoarticular
mono_noload_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip50knee30_noload_kneemuscles_moment'],gl_noload,direction=True)
...
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/RMSE.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
mono_noload_modified_AF_dic = {'positive_power' : exo_power_dataset['monoarticular_hip50knee30_noload_hipactuator_avg_positive_power']+exo_power_dataset['monoarticular_hip50knee30_noload_kneeactuator_avg_positive_power'],
                               'negative_power' : exo_power_dataset['monoarticular_hip50knee30_noload_hipactuator_avg_negative_power']+exo_power_dataset['monoarticular_hip50knee30_noload_kneeactuator_avg_negative_power'],
                                  ...
                                  'exo_inertia' : [mono_noload_I_thigh,mono_noload_I_shank,0],
                                           'gl' : gl_noload}
bi_noload_modified_AF_dic = {'positive_power' : exo_power_dataset['biarticular_hip30knee70_noload_hipactuator_avg_positive_power']+exo_power_dataset['biarticular_hip30knee70_noload_kneeactuator_avg_positive_power'],
                             'negative_power' : exo_power_dataset['biarticular_hip30knee70_noload_hipactuator_avg_negative_power']+exo_power_dataset['biarticular_hip30knee70_noload_kneeactuator_avg_negative_power'],
...
ax.axis('off')
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exos_Inertial_Properties.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/PaperFigure_TorqueProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
