...
# Energy
noload_bi_metabolics = utils.reduction_calc(unassisted_energy_dataset['noload_metabolics_energy'],assisted_energy_dataset['biarticular_hip30knee70_noload_metabolics_energy'])
noload_mono_metabolics = utils.reduction_calc(unassisted_energy_dataset['noload_metabolics_energy'],assisted_energy_dataset['monoarticular_hip50knee30_noload_metabolics_energy'])
...
metabolic_rate_data = np.concatenate((np.reshape(unassisted_energy_dataset['noload_metabolics_energy'],(7,3),order='F'),\
                                np.reshape(assisted_energy_dataset['monoarticular_hip50knee30_noload_metabolics_energy'],(7,3),order='F'),\
                                np.reshape(assisted_energy_dataset['biarticular_hip30knee70_noload_metabolics_energy'],(7,3),order='F')),axis=0)
...
assistive_actuators_avg_totalpower_data = np.concatenate((np.reshape(assisted_energy_dataset['biarticular_hip30knee70_noload_hipactuator_energy'],(7,3),order='F'),\
                                                        np.reshape(assisted_energy_dataset['biarticular_hip30knee70_noload_kneeactuator_energy'],(7,3),order='F'),\
                                                        np.reshape(assisted_energy_dataset['monoarticular_hip50knee30_noload_hipactuator_energy'],(7,3),order='F'),\
                                                        np.reshape(assisted_energy_dataset['monoarticular_hip50knee30_noload_kneeactuator_energy'],(7,3),order='F')),axis=0)
...
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Metabolic_Rate_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Metabolic_Percent_ParPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [utils.mean_over_trials(unassisted_energy_dataset['noload_metabolics_energy']),\
        ...
        utils.mean_over_trials(assisted_energy_dataset['biarticular_hip30knee70_noload_metabolics_energy'])]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Metabolic_Rate_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
x = np.arange(1,len(names)+1,1)
data = [utils.mean_over_trials(assisted_energy_dataset['biarticular_hip30knee70_noload_hipactuator_energy']),\
        ...
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip50knee30_noload_kneeactuator_energy'])]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
bp = ax.boxplot(data, patch_artist=True)
utils.beautiful_boxplot(bp)
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/PaperFigure_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
