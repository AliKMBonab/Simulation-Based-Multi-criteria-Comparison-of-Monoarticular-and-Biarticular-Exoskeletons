...
loaded_bi_metabolics = utils.reduction_calc(unassisted_energy_dataset['loaded_metabolics_energy'],assisted_energy_dataset['biarticular_hip50knee60_load_metabolics_energy'])
...
mean_loaded_bi_energy,std_loaded_bi_energy = utils.mean_std_over_subjects(assisted_energy_dataset['biarticular_hip50knee60_load_metabolics_energy'],ax=0)
#####################################################################################
...
metabolic_rate_data = np.concatenate((np.reshape(unassisted_energy_dataset['noload_metabolics_energy'],(7,3),order='F'),\
                                ...
                                np.reshape(assisted_energy_dataset['biarticular_hip50knee60_load_metabolics_energy'],(7,3),order='F'),\
                                np.reshape(assisted_energy_dataset['biarticular_hip30knee50_noload_metabolics_energy'],(7,3),order='F')),axis=0)
final_dataset = np.column_stack([assistance_col,metabolic_rate_data])
final_dataset = np.column_stack([subject_col,final_dataset])
with open(r'.\Statistics\Specific_Weights\NoloadBi23_LoadedBi12\MetabolicRate_Dataset.csv', 'wb') as f:
...
assistive_actuators_avg_totalpower_data = np.concatenate((np.reshape(assisted_energy_dataset['biarticular_hip30knee50_noload_hipactuator_energy'],(7,3),order='F'),\
                                                        np.reshape(assisted_energy_dataset['biarticular_hip30knee50_noload_kneeactuator_energy'],(7,3),order='F'),\
                                                        np.reshape(assisted_energy_dataset['biarticular_hip50knee60_load_hipactuator_energy'],(7,3),order='F'),\
                                                        np.reshape(assisted_energy_dataset['biarticular_hip50knee60_load_kneeactuator_energy'],(7,3),order='F')),axis=0)
final_dataset = np.column_stack([assistive_actuators_col,assistive_actuators_avg_totalpower_data])
final_dataset = np.column_stack([subject_col,final_dataset])
with open(r'.\Statistics\Specific_Weights\NoloadBi23_LoadedBi12\ActuatorsAvgPower_Dataset.csv', 'wb') as f:
  f.write(bytes(utils.listToString(headers)+'\n','UTF-8'))
  np.savetxt(f, final_dataset, fmt='%s', delimiter=",")
...
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Metabolic_Rate_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Metabolic_Percent_ParPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [utils.mean_over_trials(unassisted_energy_dataset['noload_metabolics_energy']),\
        ...
        utils.mean_over_trials(assisted_energy_dataset['biarticular_hip50knee60_load_metabolics_energy']),\
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Metabolic_Rate_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [utils.mean_over_trials(assisted_energy_dataset['biarticular_hip30knee50_noload_hipactuator_energy']),\
        ...
        utils.mean_over_trials(assisted_energy_dataset['biarticular_hip50knee60_load_hipactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['biarticular_hip50knee60_load_kneeactuator_energy'])]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
bp = ax.boxplot(data, patch_artist=True)
utils.beautiful_boxplot(bp)
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/PaperFigure_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
