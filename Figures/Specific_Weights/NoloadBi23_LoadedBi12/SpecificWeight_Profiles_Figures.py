...
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/RMSE.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
bi_loaded_modified_AF_dic = {'positive_power' : exo_power_dataset['biarticular_hip50knee60_load_hipactuator_avg_positive_power']+exo_power_dataset['biarticular_hip50knee60_load_kneeactuator_avg_positive_power'],
                               'negative_power' : exo_power_dataset['biarticular_hip50knee60_load_hipactuator_avg_negative_power']+exo_power_dataset['biarticular_hip50knee60_load_kneeactuator_avg_negative_power'],
...
ax.axis('off')
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exos_Inertial_Properties.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/PaperFigure_TorqueProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/PaperFigure_PowerProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/PaperFigure_Profiles.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadBi23_LoadedBi12/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
