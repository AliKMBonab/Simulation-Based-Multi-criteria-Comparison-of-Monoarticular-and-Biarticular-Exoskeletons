...
metabolic_rate_data = np.concatenate((np.reshape(unassisted_energy_dataset['noload_metabolics_energy'],(7,3)),\
                                np.reshape(assisted_energy_dataset['monoarticular_hip60knee70_noload_metabolics_energy'],(7,3)),\
                                np.reshape(assisted_energy_dataset['biarticular_hip50knee60_noload_metabolics_energy'],(7,3))),axis=0)
