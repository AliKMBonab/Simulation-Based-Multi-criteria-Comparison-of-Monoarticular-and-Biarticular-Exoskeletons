...
# biarticular
# hip
bi_loaded_hip_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip50knee70_load_hipactuator_torque'],gl_noload,direction=False)
mean_bi_loaded_hip_torque,std_bi_loaded_hip_torque = utils.mean_std_over_subjects(bi_loaded_hip_torque,avg_trials=False)
# knee
bi_loaded_knee_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip50knee70_load_kneeactuator_torque'],gl_noload,direction=True)
mean_bi_loaded_knee_torque,std_bi_loaded_knee_torque = utils.mean_std_over_subjects(bi_loaded_knee_torque,avg_trials=False)
# monoarticular
# hip
mono_loaded_hip_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip70knee70_load_hipactuator_torque'],gl_noload,direction=False)
...
# knee
mono_loaded_knee_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip70knee70_load_kneeactuator_torque'],gl_noload,direction=True)
...
# biarticular
# hip
bi_loaded_hip_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip50knee70_load_hipactuator_power'],gl_noload,direction=False)
mean_bi_loaded_hip_power,std_bi_loaded_hip_power = utils.mean_std_over_subjects(bi_loaded_hip_power,avg_trials=False)
# knee
bi_loaded_knee_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip50knee70_load_kneeactuator_power'],gl_noload,direction=False)
mean_bi_loaded_knee_power,std_bi_loaded_knee_power = utils.mean_std_over_subjects(bi_loaded_knee_power,avg_trials=False)
# monoarticular
# hip
mono_loaded_hip_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip70knee70_load_hipactuator_power'],gl_noload,direction=False)
mean_mono_loaded_hip_power,std_mono_loaded_hip_power = utils.mean_std_over_subjects(mono_loaded_hip_power,avg_trials=False)
# knee
mono_loaded_knee_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip70knee70_load_kneeactuator_power'],gl_noload,direction=False)
...
# biarticular
# hip
bi_loaded_hip_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip50knee70_load_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_bi_loaded_hip_speed,std_bi_loaded_hip_speed = utils.mean_std_over_subjects(bi_loaded_hip_speed,avg_trials=False)
# knee
bi_loaded_knee_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip50knee70_load_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
mean_bi_loaded_knee_speed,std_bi_loaded_knee_speed = utils.mean_std_over_subjects(bi_loaded_knee_speed,avg_trials=False)
# monoarticular
# hip
mono_loaded_hip_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip70knee70_load_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_mono_loaded_hip_speed,std_mono_loaded_hip_speed = utils.mean_std_over_subjects(mono_loaded_hip_speed,avg_trials=False)
# knee
mono_loaded_knee_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip70knee70_load_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
...
# hip muscles moment
# biarticular
bi_loaded_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip50knee70_load_hipmuscles_moment'],gl_noload,direction=True)
...
# monoarticular
mono_loaded_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip70knee70_load_hipmuscles_moment'],gl_noload,direction=True)
...
# knee muscles moment
# biarticular
bi_loaded_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip50knee70_load_kneemuscles_moment'],gl_noload,direction=True)
...
# monoarticular
mono_loaded_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip70knee70_load_kneemuscles_moment'],gl_noload,direction=True)
...
# rmse and tables
# torque difference
mean_rmse_hip_actuator_torque,std_rmse_hip_actuator_torque = utils.profiles_all_phases_rmse(bi_loaded_hip_torque,mono_loaded_hip_torque,loaded_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
mean_rmse_knee_actuator_torque,std_rmse_knee_actuator_torque = utils.profiles_all_phases_rmse(bi_loaded_knee_torque,mono_loaded_knee_torque,loaded_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
# power difference
mean_rmse_hip_actuator_power,std_rmse_hip_actuator_power = utils.profiles_all_phases_rmse(bi_loaded_hip_power,mono_loaded_hip_power,loaded_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
mean_rmse_knee_actuator_power,std_rmse_knee_actuator_power = utils.profiles_all_phases_rmse(bi_loaded_knee_power,mono_loaded_knee_power,loaded_toe_off,loaded_toe_off,which_comparison='ideal vs ideal')
...
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/RMSE.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
bi_loaded_hip_weight = 50
bi_loaded_knee_weight = 70
mono_loaded_hip_weight = 70
mono_loaded_knee_weight = 70
...
mono_loaded_modified_AF_dic = {'positive_power' : exo_power_dataset['monoarticular_hip70knee70_load_hipactuator_avg_positive_power']+exo_power_dataset['monoarticular_hip70knee70_load_kneeactuator_avg_positive_power'],
                               'negative_power' : exo_power_dataset['monoarticular_hip70knee70_load_hipactuator_avg_negative_power']+exo_power_dataset['monoarticular_hip70knee70_load_kneeactuator_avg_negative_power'],
                                  ...
                                  'exo_inertia' : [mono_loaded_I_thigh,mono_loaded_I_shank,0],
                                           'gl' : gl_noload}
bi_loaded_modified_AF_dic = {'positive_power' : exo_power_dataset['biarticular_hip50knee70_load_hipactuator_avg_positive_power']+exo_power_dataset['biarticular_hip50knee70_load_kneeactuator_avg_positive_power'],
                             'negative_power' : exo_power_dataset['biarticular_hip50knee70_load_hipactuator_avg_negative_power']+exo_power_dataset['biarticular_hip50knee70_load_kneeactuator_avg_negative_power'],
...
ax.axis('off')
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exos_Inertial_Properties.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/PaperFigure_TorqueProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/PaperFigure_PowerProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/PaperFigure_Profiles.pdf',orientation='landscape',bbox_inches='tight')
#******************************************************************************************************************************
#******************************************************************************************************************************
...
'plot_3_list' : [bi_loaded_hip_musclesmoment_dic, mono_loaded_hip_musclesmoment_dic],
'plot_2_list' : [bi_loaded_hip_torque_dic,mono_loaded_hip_torque_dic],
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_3_list' : [bi_loaded_knee_musclesmoment_dic,mono_loaded_knee_musclesmoment_dic],
'plot_2_list' : [bi_loaded_knee_torque_dic,mono_loaded_knee_torque_dic],
...
fig.subplots_adjust(top=0.98, bottom=0.075, left=0.100, right=0.975,hspace=0.25,wspace=0.15)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
'plot_2_list' : [bi_loaded_hip_power_dic,mono_loaded_hip_power_dic],
'plot_titles' : ['loaded biarticular hip joint','loaded monoarticular hip joint']
}
# plot
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_2_list' : [bi_loaded_knee_power_dic,mono_loaded_knee_power_dic],
'plot_titles' : ['loaded biarticular knee joint','loaded monoarticular knee joint']
}
# 
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
'plot_2_list' : [bi_loaded_hip_speed_dic,mono_loaded_hip_speed_dic],
'plot_titles' : ['loaded biarticular hip joint','loaded monoarticular hip joint']
}
# plot
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
'plot_2_list' : [bi_loaded_knee_speed_dic,mono_loaded_knee_speed_dic],
'plot_titles' : ['loaded biarticular knee joint','loaded monoarticular knee joint']
}
# plot
fig = plt.figure(num='Loaded Knee Speed',figsize=(9.4, 6.8))
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
