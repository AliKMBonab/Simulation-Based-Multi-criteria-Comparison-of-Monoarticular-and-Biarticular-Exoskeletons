...
# muscles activation
# biarticular
bi_loaded_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['biarticular_hip50knee70_load_ninemuscles_activation'],gl_loaded,direction=False,normalize=False)
...
# monoarticular
mono_loaded_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['monoarticular_hip70knee70_load_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Biarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/Monoarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedMono01_LoadedBi11/MonoarticularVSBiarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
