...
# muscles activation
# biarticular
bi_loaded_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['biarticular_hip40knee60_load_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
bi_noload_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['biarticular_hip30knee30_noload_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Biarticular_Loaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Biarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Biarticular_LoadedVsNoload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
