...
loaded_bi_metabolics = utils.reduction_calc(unassisted_energy_dataset['loaded_metabolics_energy'],assisted_energy_dataset['biarticular_hip40knee60_load_metabolics_energy'])
noload_bi_metabolics = utils.reduction_calc(unassisted_energy_dataset['noload_metabolics_energy'],assisted_energy_dataset['biarticular_hip30knee30_noload_metabolics_energy'])
...
mean_noload_bi_energy,std_noload_bi_energy = utils.mean_std_over_subjects(assisted_energy_dataset['biarticular_hip30knee30_noload_metabolics_energy'],ax=0)
mean_loaded_bi_energy,std_loaded_bi_energy = utils.mean_std_over_subjects(assisted_energy_dataset['biarticular_hip40knee60_load_metabolics_energy'],ax=0)
...
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Metabolics_Energy_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
utils.no_top_right(ax)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Metabolics_Reduction_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [unassisted_energy_dataset['loaded_metabolics_energy'],assisted_energy_dataset['biarticular_hip40knee60_load_metabolics_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip40knee60_load_metabolics_energy'])],\
        unassisted_energy_dataset['noload_metabolics_energy'],assisted_energy_dataset['biarticular_hip30knee30_noload_metabolics_energy']]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
...
utils.no_top_right(ax)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Metabolics_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
x = np.arange(1,len(names)+1,1)
data = [assisted_energy_dataset['biarticular_hip40knee60_load_hipactuator_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip40knee60_load_hipactuator_energy'])],assisted_energy_dataset['biarticular_hip40knee60_load_kneeactuator_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip40knee60_load_kneeactuator_energy'])],\
        assisted_energy_dataset['biarticular_hip30knee30_noload_hipactuator_energy'],assisted_energy_dataset['biarticular_hip30knee30_noload_kneeactuator_energy']]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
bp = ax.boxplot(data, patch_artist=True)
utils.beautiful_boxplot(bp)
...
utils.no_top_right(ax)
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi17_NoloadBi25/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
