...
metabolic_rate_data = np.concatenate((utils.mean_over_trials(unassisted_energy_dataset['noload_metabolics_energy']),\
                                ...
                                utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip60knee70_noload_metabolics_energy'])),axis=0)
...
assistive_actuators_avg_totalpower_data = np.concatenate((utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip60knee70_noload_hipactuator_energy']),\
