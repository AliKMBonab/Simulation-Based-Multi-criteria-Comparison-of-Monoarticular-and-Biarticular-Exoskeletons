...
metabolic_rate_data = np.concatenate((utils.mean_over_trials(unassisted_energy_dataset['loaded_metabolics_energy']),\
                                ...
                                utils.mean_over_trials(assisted_energy_dataset['biarticular_hip40knee70_load_metabolics_energy'])),axis=0)
...
assistive_actuators_avg_totalpower_data = np.concatenate((utils.mean_over_trials(assisted_energy_dataset['biarticular_hip40knee70_load_hipactuator_energy']),\
                                                ...
                                                utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip70knee40_load_kneeactuator_energy'])),axis=0)
