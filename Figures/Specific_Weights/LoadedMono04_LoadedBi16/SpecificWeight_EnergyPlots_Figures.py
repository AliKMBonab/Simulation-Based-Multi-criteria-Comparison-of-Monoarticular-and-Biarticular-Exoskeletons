...
metabolic_rate_data = np.concatenate((np.reshape(unassisted_energy_dataset['loaded_metabolics_energy'],(7,3),order='F'),\
                                ...
                                np.reshape(assisted_energy_dataset['biarticular_hip40knee70_load_metabolics_energy'],(7,3),order='F')),axis=0)
...
assistive_actuators_avg_totalpower_data = np.concatenate((np.reshape(assisted_energy_dataset['biarticular_hip40knee70_load_hipactuator_energy'],(7,3),order='F'),\
                                                np.reshape(assisted_energy_dataset['biarticular_hip40knee70_load_kneeactuator_energy'],(7,3),order='F'),\
