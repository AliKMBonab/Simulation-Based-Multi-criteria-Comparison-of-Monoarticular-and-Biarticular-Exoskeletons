...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Monoarticular_NoloadVsLoaded_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
