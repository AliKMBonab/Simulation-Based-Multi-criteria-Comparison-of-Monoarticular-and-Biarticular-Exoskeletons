...
loaded_mono_metabolics = utils.reduction_calc(unassisted_energy_dataset['loaded_metabolics_energy'],assisted_energy_dataset['monoarticular_hip70knee30_load_metabolics_energy'])
...
mean_loaded_mono_energy,std_loaded_mono_energy = utils.mean_std_over_subjects(assisted_energy_dataset['monoarticular_hip70knee30_load_metabolics_energy'],ax=0)
...
metabolic_rate_data = np.concatenate((utils.mean_over_trials(unassisted_energy_dataset['noload_metabolics_energy']),\
                                ...
                                utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_metabolics_energy'])),axis=0)
...
assistive_actuators_avg_totalpower_data = np.concatenate((utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_hipactuator_energy']),\
                                                        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_kneeactuator_energy']),\
                                                        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip70knee30_load_hipactuator_energy']),\
                                                        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip70knee30_load_kneeactuator_energy'])),axis=0)
...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Metabolic_Rate_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Metabolic_Percent_ParPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Metabolic_Rate_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
x = np.arange(1,len(names)+1,1)
data = [utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_hipactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip30knee30_noload_kneeactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip70knee30_load_hipactuator_energy']),\
        utils.mean_over_trials(assisted_energy_dataset['monoarticular_hip70knee30_load_kneeactuator_energy'])]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
bp = ax.boxplot(data, patch_artist=True)
utils.beautiful_boxplot(bp)
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/PaperFigure_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
