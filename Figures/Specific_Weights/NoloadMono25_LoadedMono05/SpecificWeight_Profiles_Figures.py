...
# monoarticular
# hip
mono_noload_hip_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip30knee30_noload_hipactuator_torque'],gl_noload,direction=False)
...
# knee
mono_noload_knee_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip30knee30_noload_kneeactuator_torque'],gl_noload,direction=True)
...
# monoarticular
# hip
mono_loaded_hip_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip70knee30_load_hipactuator_torque'],gl_noload,direction=False)
...
# knee
mono_loaded_knee_torque = utils.normalize_direction_data(exo_torque_dataset['monoarticular_hip70knee30_load_kneeactuator_torque'],gl_noload,direction=True)
...
# monoarticular
# hip
mono_noload_hip_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip30knee30_noload_hipactuator_power'],gl_noload,direction=False)
mean_mono_noload_hip_power,std_mono_noload_hip_power = utils.mean_std_over_subjects(mono_noload_hip_power,avg_trials=False)
# knee
mono_noload_knee_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip30knee30_noload_kneeactuator_power'],gl_noload,direction=False)
...
# monoarticular
# hip
mono_loaded_hip_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip70knee30_load_hipactuator_power'],gl_noload,direction=False)
mean_mono_loaded_hip_power,std_mono_loaded_hip_power = utils.mean_std_over_subjects(mono_loaded_hip_power,avg_trials=False)
# knee
mono_loaded_knee_power = utils.normalize_direction_data(exo_power_dataset['monoarticular_hip70knee30_load_kneeactuator_power'],gl_noload,direction=False)
...
# monoarticular
# hip
mono_noload_hip_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip30knee30_noload_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_mono_noload_hip_speed,std_mono_noload_hip_speed = utils.mean_std_over_subjects(mono_noload_hip_speed,avg_trials=False)
# knee
mono_noload_knee_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip30knee30_noload_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
...
# monoarticular
# hip
mono_loaded_hip_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip70knee30_load_hipactuator_speed'],gl_noload,direction=False,normalize=False)
mean_mono_loaded_hip_speed,std_mono_loaded_hip_speed = utils.mean_std_over_subjects(mono_loaded_hip_speed,avg_trials=False)
# knee
mono_loaded_knee_speed = utils.normalize_direction_data(exo_speed_dataset['monoarticular_hip70knee30_load_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
...
# hip muscles moment
# monoarticular
mono_noload_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip30knee30_noload_hipmuscles_moment'],gl_noload,direction=True)
...
# monoarticular
mono_loaded_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip70knee30_load_hipmuscles_moment'],gl_noload,direction=True)
...
# knee muscles moment
# monoarticular
mono_noload_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip30knee30_noload_kneemuscles_moment'],gl_noload,direction=True)
...
# monoarticular
mono_loaded_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['monoarticular_hip70knee30_load_kneemuscles_moment'],gl_noload,direction=True)
...
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/RMSE.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
mono_noload_hip_weight = 30
mono_noload_knee_weight = 30
mono_loaded_hip_weight = 70
mono_loaded_knee_weight = 30
...
mono_loaded_modified_AF_dic = {'positive_power' : exo_power_dataset['monoarticular_hip70knee30_load_hipactuator_avg_positive_power']+exo_power_dataset['monoarticular_hip70knee30_load_kneeactuator_avg_positive_power'],
                               'negative_power' : exo_power_dataset['monoarticular_hip70knee30_load_hipactuator_avg_negative_power']+exo_power_dataset['monoarticular_hip70knee30_load_kneeactuator_avg_negative_power'],
                                  ...
                                  'exo_inertia' : [mono_loaded_I_thigh,mono_loaded_I_shank,0],
                                           'gl' : gl_noload}
mono_noload_modified_AF_dic = {'positive_power' : exo_power_dataset['monoarticular_hip30knee30_noload_hipactuator_avg_positive_power']+exo_power_dataset['monoarticular_hip30knee30_noload_kneeactuator_avg_positive_power'],
                             'negative_power' : exo_power_dataset['monoarticular_hip30knee30_noload_hipactuator_avg_negative_power']+exo_power_dataset['monoarticular_hip30knee30_noload_kneeactuator_avg_negative_power'],
...
ax.axis('off')
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exos_Inertial_Properties.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/PaperFigure_PowerProfiles.pdf',orientation='landscape',bbox_inches='tight')
...
fig = plt.figure(num='Noload Knee Torque',figsize=(6.4*3, 4.8*2))
...
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/PaperFigure_Profiles.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
# plot
fig = plt.figure(num='Noload Knee Torque',figsize=(6.4, 4.8))
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/NoloadMono25_LoadedMono05/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
