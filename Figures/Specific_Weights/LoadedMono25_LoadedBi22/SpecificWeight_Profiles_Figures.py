...
monovsbi_color_dic = {
'color_1_list' : ['k','k'],
'color_2_list' : [mycolors['dark purple'],mycolors['dark purple'],mycolors['lavender purple']],
'color_3_list' : [mycolors['crimson red'],mycolors['crimson red'],mycolors['french rose']]
}
