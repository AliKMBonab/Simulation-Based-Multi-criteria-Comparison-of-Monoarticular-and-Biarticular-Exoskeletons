...
# Energy
loaded_bi_metabolics = utils.reduction_calc(unassisted_energy_dataset['loaded_metabolics_energy'],assisted_energy_dataset['biarticular_hip30knee60_load_metabolics_energy'])
...
mean_loaded_bi_energy,std_loaded_bi_energy = utils.mean_std_over_subjects(assisted_energy_dataset['biarticular_hip30knee60_load_metabolics_energy'],ax=0)
...
fig.savefig('./Figures/Specific_Weights/LoadedMono25_LoadedBi22/Metabolic_Rate_BarPlot.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono25_LoadedBi22/Metabolic_Percent_ParPlot.pdf',orientation='landscape',bbox_inches='tight')
...
data = [unassisted_energy_dataset['loaded_metabolics_energy'],\
        assisted_energy_dataset['monoarticular_hip30knee30_load_metabolics_energy'],assisted_energy_dataset['biarticular_hip30knee60_load_metabolics_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip30knee60_load_metabolics_energy'])]]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono25_LoadedBi22/Metabolic_Rate_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
...
x = np.arange(1,len(names)+1,1)
data = [assisted_energy_dataset['biarticular_hip30knee60_load_hipactuator_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip30knee60_load_hipactuator_energy'])],\
        assisted_energy_dataset['biarticular_hip30knee60_load_kneeactuator_energy'][~np.isnan(assisted_energy_dataset['biarticular_hip30knee60_load_kneeactuator_energy'])],\
        assisted_energy_dataset['monoarticular_hip30knee30_load_hipactuator_energy'],assisted_energy_dataset['monoarticular_hip30knee30_load_kneeactuator_energy']]
fig, ax = plt.subplots(figsize=(6.4, 4.8))
bp = ax.boxplot(data, patch_artist=True)
utils.beautiful_boxplot(bp)
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedMono25_LoadedBi22/Actuator_Energy_BoxPlot.pdf',orientation='landscape',bbox_inches='tight')
