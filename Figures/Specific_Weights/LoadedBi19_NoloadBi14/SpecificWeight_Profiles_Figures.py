...
# biarticular
# hip
bi_loaded_hip_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip40knee40_load_hipactuator_torque'],gl_noload,direction=False)
...
# knee
bi_loaded_knee_torque = utils.normalize_direction_data(exo_torque_dataset['biarticular_hip40knee40_load_kneeactuator_torque'],gl_noload,direction=True)
...
# biarticular
# hip
bi_loaded_hip_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip40knee40_load_hipactuator_power'],gl_noload,direction=False)
...
# knee
bi_loaded_knee_power = utils.normalize_direction_data(exo_power_dataset['biarticular_hip40knee40_load_kneeactuator_power'],gl_noload,direction=False)
...
# biarticular
# hip
bi_loaded_hip_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip40knee40_load_hipactuator_speed'],gl_noload,direction=False,normalize=False)
...
# knee
bi_loaded_knee_speed = utils.normalize_direction_data(exo_speed_dataset['biarticular_hip40knee40_load_kneeactuator_speed'],gl_noload,direction=True,normalize=False)
...
# hip muscles moment
# biarticular
bi_loaded_hipmuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip40knee40_load_hipmuscles_moment'],gl_noload,direction=True)
...
# knee muscles moment
# biarticular
bi_loaded_kneemuscles_moment = utils.normalize_direction_data(musclesmoment_dataset['biarticular_hip40knee40_load_kneemuscles_moment'],gl_noload,direction=True)
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedBi19_NoloadBi14/Exoskeletons_Hip_Torque.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi19_NoloadBi14/Exoskeletons_Knee_Torque.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedBi19_NoloadBi14/Exoskeletons_Hip_Power.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi19_NoloadBi14/Exoskeletons_Knee_Power.pdf',orientation='landscape',bbox_inches='tight')
...
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/LoadedBi19_NoloadBi14/Exoskeletons_Hip_Speed.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.show()
fig.savefig('./Figures/Specific_Weights/LoadedBi19_NoloadBi14/Exoskeletons_Knee_Speed.pdf',orientation='landscape',bbox_inches='tight')
