...
\begin{adjustwidth}{-2.3in}{0in}
	...
	\begin{tabular}{c!{\vline width 0.2pt}c!{\vline width 0.2pt}c!{\vline width 0.2pt}c!{\vline width 0.2pt}c!{\vline width 0.2pt}c}
		...
		&  &  &\textbf{consumption (W/kg)} & \textbf{consumption (W/kg)} & \textbf{reduction (\%)} \\
		\midrule[0.75pt]
		\multirow{4}{*}{\textbf{Biarticular}} & Ideal & noload & 4.65 $\pm$ 0.75 & 5.10 $\pm$ 0.81\textsuperscript{C} & 22.38 $\pm$ 4.91 \\
		\cmidrule[0.2pt]{2-6}
		...
		\midrule[0.75pt]
		\multirow{4}{*}{\textbf{Monoarticular}} & Ideal & noload & 2.92 $\pm$ 0.44 & 4.24 $\pm$ 0.74 & 22.47 $\pm$ 4.89 \\
		\cmidrule[0.2pt]{2-6}
		...
		\bottomrule
		\multicolumn{6}{l}{\small{Note: equal superscripts indicate a pairwise statistically significant difference (7 subjects, 3 trails, Tukey Post-hoc, $P < 0.05$).}} \\
	\end{tabular}%
