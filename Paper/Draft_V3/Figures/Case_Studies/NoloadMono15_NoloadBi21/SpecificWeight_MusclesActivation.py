...
# muscles activation
# biarticular
bi_noload_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['biarticular_hip30knee70_noload_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
...
# monoarticular
mono_noload_muscles_activation = utils.normalize_direction_data(musclesactivation_dataset['monoarticular_hip50knee30_noload_ninemuscles_activation'],gl_noload,direction=False,normalize=False)
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Biarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/Monoarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
...
plt.show()
fig.tight_layout()
fig.savefig('./Figures/Specific_Weights/NoloadMono15_NoloadBi21/MonoarticularVSBiarticular_Noload_MusclesActivation.pdf',orientation='landscape',bbox_inches='tight')
