...
To have systematic comparisons among each scenario, we set statistical analyses for the results of assisted and unassisted subject simulations. Two main objectives in this study were the effect of exoskeleton on human metabolic cost and the exoskeletons' power consumption where they need to be tested among scenarios to study if there is any statistically significant difference among the assistance scenarios or not. Since the simulations were done on seven subjects with three trials in five different scenarios, repeated measures analysis of variance (ANOVA) and Tukey Post-hoc were employed for statistical analyses. Additionally, for each represented profile, mean and standard deviations were calculated and represented in figures.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
