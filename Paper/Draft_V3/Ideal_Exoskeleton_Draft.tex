...
\begin{figure*}[ht!]
	\centering
	\subfloat[\small{biarticular muscles}]{\includegraphics[width=2.5in]{Case_Studies/LoadedMono04_LoadedBi16/PaperFigure_PowerProfiles.pdf}
		\label{y}}
	\hfil
	\subfloat[\small{monoarticular muscles}]{\includegraphics[width=2.5in]{Case_Studies/LoadedMono04_LoadedBi16/PaperFigure_TorqueProfiles.pdf}
		\label{x}}
	\vspace{1mm}
	\caption{\small{\textbf{x}}}
	\label{dd}
\end{figure*}
\begin{figure*}[ht]   
	\centering
	\includegraphics[width=\linewidth]{Case_Studies/LoadedMono04_LoadedBi16/PaperFigure_TorqueProfiles.pdf}
	\vspace{1mm}
	\caption{\small{\textbf{torque profile.} explain.}}
	\label{Fig_Case01_Torque_Profiles}
\end{figure*}
\begin{figure*}[ht]   
	\centering
	\includegraphics[width=\linewidth]{Case_Studies/LoadedMono04_LoadedBi16/PaperFigure_PowerProfiles.pdf}
	\vspace{1mm}
	\caption{\small{\textbf{power profile.} explain.}}
	\label{Fig_Case01_Power_Profiles}
\end{figure*}
\begin{figure*}[ht]   
	\centering
...
\end{figure*}
The overall trend between torque profiles of the monoarticular and biarticular devices is similar, which can be seen in figure \ref{Fig_Case01_Torque_Profiles} qualitatively, and root mean square error between the profiles during the whole gait cycle can also proof this quantitatively claim as shown in figure \ref{Fig_Case01_RMSE}. The detailed analysis of the gait cycle shows that the main difference between torque profiles of hip actuators is occurring during the stance phases and monoarticular deliver more hip extension torque than the biarticular device, especially during the mid-stance and terminal-stance phases (Fig. \ref{Fig_Case01_Torque_Profiles} and \ref{Fig_Case01_RMSE}). Although the difference between profiles of hip actuators follow similar trajectories during the swing phase, the terminal-swing phase of these actuators is considerably different in which monoarticular deliver extension while biarticular provide flexion torque to the joint.\\
