...
mono_noload_Aa_metabolics_percent = np.reshape(mono_noload_metabolics_percent[14,:],(7,3))
# actuators energy
# loaded bi
...
# noload mono
mono_noload_Aa_hip_energy = np.reshape(mono_noload_hip_energy[14,:],(7,3))
mono_noload_Aa_knee_energy = np.reshape(mono_noload_knee_energy[14,:],(7,3))
mono_noload_Aa_hip_power = np.reshape(mono_noload_hip_max_power[14,:],(7,3))
mono_noload_Aa_knee_power = np.reshape(mono_noload_knee_max_power[14,:],(7,3))
#####################################################################################
...
loaded_condition_col = np.repeat(np.array('loaded'),7*4)
noload_condition_col = np.repeat(np.array('noload'),7*4)
biarticular_device_col = np.repeat(np.array('biarticular'),7*2)
monoarticular_device_col = np.repeat(np.array('monoarticular'),7*2)
constrained_condition_col = np.repeat(np.array('constrained'),7*8)
...
final_dataset = np.column_stack([general_load_condition_col,constrained_condition_col,general_device_col,general_actuator_col,assistive_actuators_max_power_data])
final_dataset = np.column_stack([subject_col,final_dataset])
...
subject_col = np.tile(subjects,8)
general_load_condition_col = np.concatenate((loaded_condition_col,noload_condition_col),axis=0)
general_device_col = np.concatenate((biarticular_device_col,biarticular_device_col,monoarticular_device_col,monoarticular_device_col,
                                     biarticular_device_col,biarticular_device_col,monoarticular_device_col,monoarticular_device_col),axis=0)
...
final_dataset = np.column_stack([general_load_condition_col,constrained_condition_col,general_actuator_col,general_device_col,assistive_actuators_avg_totalpower_data])
final_dataset = np.column_stack([subject_col,final_dataset])
