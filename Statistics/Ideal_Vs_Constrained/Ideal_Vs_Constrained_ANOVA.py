...
# metabolics cost reduction percents
bi_loaded_Aa_metabolics_percent = np.reshape(bi_loaded_metabolics_percent[10,:],(7,3))
bi_noload_Aa_metabolics_percent = np.reshape(bi_noload_metabolics_percent[16,:],(7,3))
mono_loaded_Aa_metabolics_percent = np.reshape(mono_loaded_metabolics_percent[3,:],(7,3))
mono_noload_Aa_metabolics_percent = np.reshape(mono_noload_metabolics_percent[12,:],(7,3))
# actuators energy
# loaded bi
bi_loaded_Aa_hip_energy = np.reshape(bi_loaded_hip_energy[10,:],(7,3))
bi_loaded_Aa_knee_energy = np.reshape(bi_loaded_knee_energy[10,:],(7,3))
bi_loaded_Aa_energy = np.reshape(bi_loaded_energy[10,:],(7,3))
# noload bi
...
# loaded mono
mono_loaded_Aa_hip_energy = np.reshape(mono_loaded_hip_energy[3,:],(7,3))
mono_loaded_Aa_knee_energy = np.reshape(mono_loaded_knee_energy[3,:],(7,3))
mono_loaded_Aa_energy = np.reshape(mono_loaded_energy[3,:],(7,3))
# noload mono
