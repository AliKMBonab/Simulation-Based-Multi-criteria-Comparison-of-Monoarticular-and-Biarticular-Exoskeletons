...
utils.plot_muscles_avg(plot_dic=muscles_activation_noload_plot_dic,toeoff_color='xkcd:shamrock green',color='xkcd:irish green',ls='--')
utils.plot_muscles_avg(plot_dic=muscles_activation_biarticular_noload_plot_dic,toeoff_color='xkcd:shamrock green',color=mycolors['french rose'],ls=':')
utils.plot_muscles_avg(plot_dic=muscles_activation_biarticular_loaded_plot_dic,color=mycolors['dark purple'],ls='-.')
...
utils.plot_muscles_avg(plot_dic=muscles_activation_loaded_plot_dic,color='k')
utils.plot_muscles_avg(plot_dic=muscles_activation_noload_plot_dic,toeoff_color='xkcd:shamrock green',color='xkcd:irish green',ls='--')
utils.plot_muscles_avg(plot_dic=muscles_activation_monoarticular_noload_plot_dic,toeoff_color='xkcd:shamrock green',color=mycolors['french rose'],ls=':')
utils.plot_muscles_avg(plot_dic=muscles_activation_monoarticular_loaded_plot_dic,color=mycolors['dark purple'],ls='-.')
plt.legend(loc='best',frameon=False)
plt.show()
fig.tight_layout()
