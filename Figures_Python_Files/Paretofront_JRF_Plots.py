...
ax.set_ylim((-0.45,0))
# bi-articular' loaded patellofemoral
...
ax.set_yticks([-0.4,-0.3,-0.2,-0.1,0])
ax.set_ylim((-0.45,0))
# bi-articular' unloaded patellofemoral
...
ax.set_yticks([-0.4,-0.3,-0.2,-0.1,0])
ax.set_ylim((-0.45,0))
# monoarticular unloaded patellofemoral
