...
fig, axes = plt.subplots(nrows=2,ncols=4,num='Pareto Curve: loaded monoarticular vs biarticular',figsize=(15.8, 11.6))
...
utils.plot_paretofront_profile_changes(plot_dic,colormap='tab20',include_colorbar=False,
                                       toeoff_color='k',add_ideal_profile=True,xlabel=True)
...
utils.plot_paretofront_profile_changes(plot_dic,colormap='tab20',include_colorbar=False,add_ideal_profile=True,
                        toeoff_color='xkcd:shamrock green')
ax.set_yticks([-1.5,-1,-0.5,0,0.5,1,1.5])
ax.set_ylim((-1.5,1.5))
...
utils.plot_paretofront_profile_changes(plot_dic,colormap='tab20',include_colorbar=False,
                                        add_ideal_profile=True,toeoff_color='xkcd:shamrock green')
ax.set_yticks([-1.5,-1,-0.5,0,0.5,1,1.5])
ax.set_ylim((-1.5,1.5))
...
fig.subplots_adjust(top=0.98, bottom=0.075, left=0.05, right=0.95,hspace=0.40,wspace=0.30)
