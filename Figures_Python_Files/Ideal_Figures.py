...
# hip muscles moment
loaded_hipmuscles_moment = utils.cmc_revise_data(musclesmoment_dataset['loaded_hip_musclesmoment'],gl_loaded)
noload_hipmuscles_moment = utils.cmc_revise_data(musclesmoment_dataset['noload_hip_musclesmoment'],gl_noload)
normal_loaded_hipmuscles_moment = utils.normalize_direction_data(loaded_hipmuscles_moment,gl_noload,direction=True)
normal_noload_hipmuscles_moment = utils.normalize_direction_data(noload_hipmuscles_moment,gl_noload,direction=True)
