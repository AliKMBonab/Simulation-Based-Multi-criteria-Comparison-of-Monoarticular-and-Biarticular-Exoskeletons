...
bi_loaded_indices = np.array([25,24,23,22,19,17,16,13,11,6,1])
...
bi_noload_indices = np.array([24,23,22,21,16,11,6,1])
...
mono_noload_indices = np.array([25,24,10,9,8,7,6,2,1])
