...
mono_noload_regen_energy = -mono_noload_hip_regen_energy - mono_noload_knee_regen_energy + mono_noload_hip_energy + mono_loaded_knee_energy
#loaded
...
bi_loaded_regen_energy = -bi_loaded_hip_regen_energy - bi_loaded_knee_regen_energy + bi_loaded_hip_energy + bi_loaded_knee_energy
...
mono_loaded_regen_energy = -mono_loaded_hip_regen_energy - mono_loaded_knee_regen_energy + mono_loaded_hip_energy + mono_loaded_knee_energy
...
plot_dic = {'x1_data':bi_loaded_metabolics_percent,'x2_data':mono_loaded_metabolics_percent,
          'y1_data':bi_loaded_regen_energy,'y2_data':mono_loaded_regen_energy,
          'color_1':mycolors['crimson red'],'color_2':mycolors['dark purple'],
          'ylabel':'Energy Consumption (W/kg)','xlabel':'Metabolic Reduction (%)'
          }
fig = plt.figure(num='Pareto Curve: loaded mono vs bi',figsize=(12.4, 18.8))
utils.plot_pareto_curve_subjects (nrows=7,ncols=3,nplot=21,plot_dic=plot_dic,loadcond='loaded')
fig.tight_layout()
fig.savefig('./Figures/Pareto/Subjects_Pareto/Pareto_Load_Subjects_BiVsMono_Regenerated.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
...
utils.plot_pareto_curve_subjects (nrows=7,ncols=3,nplot=21,plot_dic=plot_dic,loadcond='noload')
fig.tight_layout()
fig.savefig('./Figures/Pareto/Subjects_Pareto/Pareto_Noload_Subjects_BiVsMono_Regenerated.pdf',orientation='landscape',bbox_inches='tight')
plt.show()
