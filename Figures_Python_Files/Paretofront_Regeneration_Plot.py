...
plt.subplot(2,2,2)
utils.paretofront_barplot(plot_dic,bi_noload_regen_indices,loadcond='unloaded')
plt.title('bi-articular, unloaded')
ax = plt.gca()
...
plt.subplot(2,2,1)
utils.paretofront_barplot(plot_dic,mono_noload_regen_indices,loadcond='unloaded')
plt.ylabel('regenerable power to\n absolute power ratio')
plt.title('mono-articular, unloaded')
ax = plt.gca()
ax.set_yticks([0,0.2,0.4,0.6,0.8,1])
plt.tight_layout()
utils.no_top_right(ax)
...
plt.title('mono-articular, loaded')
plt.ylabel('regenerable power to\n absolute power ratio')
ax = plt.gca()
ax.set_yticks([0,0.2,0.4,0.6,0.8,1])
plt.tight_layout()
...
plt.title('loaded: bi-articular regenerated')
ax = plt.gca()
plt.tick_params(axis='both',direction='in')
utils.no_top_right(ax)
plt.legend(loc='best',frameon=False)
...
plt.title('loaded: mono-articular regenerated')
ax = plt.gca()
plt.tick_params(axis='both',direction='in')
utils.no_top_right(ax)
# noload biarticular
...
plt.title('unloaded: bi-articular regenerated')
plt.ylabel('Exoskeleton Energy\n Consumption (W/kg)')
...
plt.title('unloaded: mono-articular regenerated')
ax = plt.gca()
plt.tick_params(axis='both',direction='in')
utils.no_top_right(ax)
ax.set_xlabel('metabolic cost\nreduction (%)')
